        ...
        <div className="mx-auto grid max-w-content gap-10 px-5 sm:px-8 lg:grid-cols-[1.25fr_0.75fr]">
          <Reveal>
            <div>
              ...
              <h3 className="mt-10 font-display text-lg font-semibold tracking-tight text-fg">Analytical mindset</h3>
              <p className="mt-3 text-base leading-relaxed text-muted">
                Work starts with the question, not the chart. Datasets are validated and cleaned before modeling, and
                reporting is structured so that a stakeholder can read the outcome without needing the analysis
                explained to them.
              </p>
              <h3 className="mt-8 font-display text-lg font-semibold tracking-tight text-fg">Career direction</h3>
              <p className="mt-3 text-base leading-relaxed text-muted">
                Focused on Data Analyst, Business Analyst, BI and reporting roles where SQL, Python and Power BI are
                used to support recurring decisions rather than one-off requests.
              </p>
            </div>
          </Reveal>
          ...
          <div className="space-y-4">
            <Reveal delay={0.06}>
              <div className="rounded-2xl border border-line bg-surface p-6 shadow-card">
                ...
                <h3 className="mt-4 font-display text-base font-semibold tracking-tight text-fg">Education</h3>
            ...
            <Reveal delay={0.12}>
                ...
                <div key={fact.label} className="rounded-xl border border-line bg-surface px-4 py-3">
                      <dt className="text-[0.66rem] uppercase tracking-[0.12em] text-muted">{fact.label}</dt>
