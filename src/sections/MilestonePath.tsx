...
interface MilestoneNode {
  ...
  route: string;
  /** x in the 1090-wide SVG viewBox */
  x: number;
  /** y in the 380-tall SVG viewBox */
  y: number;
...
const milestones: MilestoneNode[] = [
  { id: 'about',        title: 'About Me',     icon: UserIcon,          route: '/about',           x: 80,   y: 190, labelUp: true  },
  { id: 'education',    title: 'Education',    icon: GraduationCapIcon, route: '/about',           x: 230,  y: 80,  labelUp: false },
  { id: 'internships',  title: 'Internships',  icon: BriefcaseIcon,     route: '/experience',      x: 390,  y: 290, labelUp: true  },
  { id: 'skills',       title: 'Skills',       icon: CpuIcon,           route: '/skills',          x: 560,  y: 80,  labelUp: false },
  { id: 'certificates', title: 'Certificates', icon: AwardIcon,         route: '/certificates',    x: 720,  y: 290, labelUp: true  },
  { id: 'projects',     title: 'Projects',     icon: BarChart3Icon,     route: '/projects',        x: 880,  y: 80,  labelUp: false },
  { id: 'contact',      title: 'Contact',      icon: MailIcon,          route: '/contact',         x: 1010, y: 190, labelUp: true  },
];

/* Organic winding path connecting all 7 nodes — like a map trail */
const PATH =
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-content px-5 sm:px-8">
        {/* Header — same SectionHeading as every other section */}
        <div id="milestone-heading">
          <SectionHeading
            eyebrow="Interactive Journey"
            title="Milestone Path"
            description="Click any glowing node to explore that section — hover a stop to see the path ahead."
          />
        </div>

        {/* ── Responsive Map Canvas ── */}
        <div className="relative mt-12 w-full">
          {/* 1090 : 380 aspect ratio — no scroll, scales with viewport */}
